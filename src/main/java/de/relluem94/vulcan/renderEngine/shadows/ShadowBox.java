...
public class ShadowBox {
	...
	public void update() {
		...
		Vector3f centerNear = Vector3f.add(toNear, Main.camc.getPosition(), null);
		Vector3f centerFar = Vector3f.add(toFar, Main.camc.getPosition(), null);
	...
	private Matrix4f calculateCameraRotationMatrix() {
		...
		rotation.rotate((float) Math.toRadians(-Main.camc.getYaw()), new Vector3f(0, 1, 0));
		rotation.rotate((float) Math.toRadians(-Main.camc.getPitch()), new Vector3f(1, 0, 0));
		return rotation;
	}
