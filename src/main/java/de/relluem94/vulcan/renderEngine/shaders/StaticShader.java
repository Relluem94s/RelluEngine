...
public class StaticShader extends ShaderProgram {
    ...
    private int location_hasShadow;

    public StaticShader() {
        super(Variables.StaticShader_VERTEX_FILE, Variables.StaticShader_FRAGMENT_FILE);
    }
    ...
    protected void getAllUniformLocations() {
        ...
        location_hasShadow = super.getUniformLocation("hasShadow");
    }
    ...
    public void loadHasShadow(boolean hasShadow) {
        super.loadBoolean(location_hasShadow, hasShadow);
    }
