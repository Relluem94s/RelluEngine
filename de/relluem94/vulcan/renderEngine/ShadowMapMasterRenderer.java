...
import de.relluem94.vulcan.renderEngine.shadows.ShadowBox;
import de.relluem94.vulcan.renderEngine.shadows.ShadowFrameBuffer;
...
public class ShadowMapMasterRenderer {
	...
	public void render() {
		shadowBox.update();
		Vector3f sunPosition = PositionComponent.getPosition(Main.sun.getID()).toVector3f();
